 ...
 */
class Mage_CatalogSearch_Block_Marcas_Form extends Mage_Core_Block_Template
{
    public function _prepareLayout()
    {
        if ($headBlock = $this->getLayout()->getBlock('head')) {
            $headBlock->setTitle(Mage::helper('catalogsearch')->__('Busca por Marcas'));
        }
        ...
        if ($breadcrumbs = $this->getLayout()->getBlock('breadcrumbs')) {
            $breadcrumbs->addCrumb('home', array(
                ...
                'label'=>Mage::helper('catalogsearch')->__('Busca por Marcas')
            ));
        }
