 ...
 */
class Mage_CatalogSearch_Block_Marcas_Result extends Mage_Core_Block_Template
{
    ...
    protected function _getProductCollection(){
		$collection = $this->getSearchModel()->getProductCollection();	
		
		$collection->addAttributeToSelect('type_id');
		$collection->addFieldToFilter(array(
			array('attribute'=>'type_id','neq'=>'grouped'),
		));
		$collection->addFieldToFilter(array(
			array('attribute'=>'visibility',array('eq'=>'2', 'eq'=>'4')),
		));
