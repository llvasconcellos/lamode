...
class Mage_Adminhtml_Block_Customer_Edit_Tab_Addresses extends Mage_Adminhtml_Block_Widget_Form
{
    ...
    public function initForm()
    {
        ...
        if ($streetElement = $form->getElement('street')) {
			...
			$streetElement->setAfterElementHtml('
			<div id="script__address">
				<script language="javascript">
					var tr = $($("script__address").parentNode.parentNode.parentNode);
					var children = tr.childElements();
					var label = children[0];
					label.innerHTML = \'<div style="line-height:28px">Logradouro</div><div style="line-height:28px">Número</div><div style="line-height:28px">Complemento</div><div style="line-height:28px">Bairro</div>\';
				</script>
			</div>');
