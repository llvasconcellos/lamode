 ...
 */
class Mage_Cms_Model_Wysiwyg_Config2 extends Varien_Object
{
    /**
     * Wysiwyg behaviour
     */
    ...
    public function getConfig($data = array())
    {
        ...
        $config->setData(array(
            ...
            'files_browser_window_url'      => Mage::getSingleton('adminhtml/url')->getUrl('*/../admin/cms_wysiwyg_images/index'),
            'files_browser_window_width'    => (int) Mage::getConfig()->getNode('adminhtml/cms/browser/window_width'),
            'files_browser_window_height'   => (int) Mage::getConfig()->getNode('adminhtml/cms/browser/window_height'),
            'encode_directives'             => true,
            'directives_url'                => Mage::getSingleton('adminhtml/url')->getUrl('*/../admin/cms_wysiwyg/directive'),
