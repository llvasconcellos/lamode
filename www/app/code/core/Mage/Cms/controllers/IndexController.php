...
class Mage_Cms_IndexController extends Mage_Core_Controller_Front_Action
{
    ...
    {
    	if((stripos($_SERVER['HTTP_USER_AGENT'], 'iphone') !== false) || (stripos($_SERVER['HTTP_USER_AGENT'], 'ipod') !== false) || (stripos($_SERVER['HTTP_USER_AGENT'], 'android') !== false)){
    		Mage::getDesign()->setTheme('iphone');
		}
		else
			Mage::getDesign()->setTheme('lamode');
