        ...
        foreach ($this->getAllowProducts() as $product) {
            ...
            foreach ($this->getAllowAttributes() as $attribute) {
                ...
                if($qty <= 0)  
                       ...
                       $txt= " - (".$qty." em estoque)";
                $options[$productAttribute->getId()]['qty-' . $attributeLabel][$productId] =  $txt;
            ...
            if (is_array($prices)) {
                foreach ($prices as $value) {
                    ...
                    $info['options'][] = array(
                        ...
                        'qty' => isset($options[$attributeId]['qty-' . $value['label']]) ? $options[$attributeId]['qty-' . $value['label']] : array(),
