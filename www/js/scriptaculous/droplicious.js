...
var dropliciousMenu = Class.create({
	...
	initialize: function(){
		...
		$$("ul.licious ul").invoke('observe', 'mousemove', this.submenuMouseOver2.bind(this));
		$$("ul.licious ul").invoke('observe', 'mouseout', this.submenuMouseOut2.bind(this));
	...
	submenuMouseOut2: function(e){
		var dropElement = e.findElement("ul").parentNode;
		if (dropElement && dropElement.hasClassName('active')){
			this.setDelayedHide(dropElement);
		}
	},

	submenuMouseOver2: function(e){
		var dropElement = e.findElement("ul").parentNode;
