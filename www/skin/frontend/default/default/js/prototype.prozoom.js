    ...
    return $$(selector).each(function(el) {
        ...
        function showLargeImage(e)
        {
            ...
            image.onload = function(){
            	if(image.height > (document.viewport.getHeight())){
            		$('largeimage').childNodes[0].height = document.viewport.getHeight()-10;
            	}

                $(largeimage).setStyle({
                    left: document.viewport.getWidth() / 2 - $('largeimage').childNodes[0].width / 2 + 'px',
