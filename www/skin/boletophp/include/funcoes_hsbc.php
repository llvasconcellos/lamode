...
//$dadosboleto["valor_boleto"] = (int)formata_numero($dadosboleto["valor_boleto"]) + (int)formata_numero('3,50');
$dadosboleto["valor_boleto"] = str_replace('.', ',', sprintf('%01.2f', (float)str_replace(",", ".", $dadosboleto["valor_boleto"]) + 3.5));
$codigobanco = "399";
...
$dadosboleto["agencia_codigo"] = $dadosboleto["agencia"] . " / " . $dadosboleto["codigo_cedente"];
