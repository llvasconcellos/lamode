...
$valor_boleto = (float) $dadosboleto["valor_boleto"];
$valor_boleto = $valor_boleto + $dadosboleto['taxa_boleto'];
$valor_boleto = number_format($valor_boleto, 2, ',', '');

//valor tem 10 digitos, sem virgula
$valor = formata_numero($valor_boleto,10,0,"valor");
//agencia é 4 digitos
$agencia = $dadosboleto["agencia"] . $dadosboleto["agencia_dv"];
...
$dadosboleto['taxa_boleto'] = number_format($dadosboleto['taxa_boleto'], 2, ',', '');
$dadosboleto['valor_cobrado_boleto'] = $valor_boleto;
